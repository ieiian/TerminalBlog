...
- **当前文章感知**：在文章页面打开 AI 时，自动传递当前文章信息给 AI
- **自动总结**：首次在文章页面打开 AI 时，自动生成文章摘要

---

### 0.5. AI 文章备注（aiNote）

每篇文章可以在 YAML front matter 中添加可选的 `aiNote` 字段，用于向 AI 说明文章的性质或背景，帮助 AI 更准确地理解和回答相关问题。
...
date: 2026-06-03
tags: ['XUANA']
aiNote: 为不熟悉指令操作的朋友准备的入门指南
---
```

**说明**：
- `aiNote` 是可选字段，可以有也可以没有
- 内容不会公开显示在博客界面上
- AI 读取后会根据此说明更好地理解文章的真实意图
- AI 不会主动提及有这个说明存在
- 不需要在 config.js 中做任何配置
...
#1020 XUANA 项目更新笔记
标签: XUANA
备注: 为不熟悉指令操作的朋友准备的入门指南
开头: ...
```

这样当用户询问相关问题时，AI 可以根据 `aiNote` 判断这是一篇面向新手的教程，从而给出更合适的回答。
